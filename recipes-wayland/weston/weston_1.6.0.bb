...
SRC_URI = "http://wayland.freedesktop.org/releases/${BPN}-${PV}.tar.xz \
           ...
           file://add_include_in_westontest_file.patch \
           file://change_makefile_suitfor_mali_waylandegl.patch \
           file://changecode_fbdevCompositor_suitfor_hifb.patch \
           file://changecode_westonlaunch_suitfor_transparam.patch \
"
...
DEPENDS += "virtual/libgles1 virtual/libgles2"
DEPENDS += "virtual/driverlibs-rdk-hisilicon"
#DEPENDS += "wayland-egl"

LDFLAGS = " -lz -lpthread -lwayland-egl"
#LDFLAGS = " -lz -lpthread"
...
#CFLAGS_append = " -DEGL_PLATFORM_FBDEV "
...
PACKAGECONFIG ??= "${@bb.utils.contains('DISTRO_FEATURES', 'wayland', 'fbdev egl', '', d)} \
                   ${@bb.utils.contains('DISTRO_FEATURES', 'x11', 'x11', '', d)} \
                   ${@bb.utils.contains('DISTRO_FEATURES', 'pam', 'launch', '', d)} \
                  "
#
